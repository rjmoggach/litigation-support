...
function Switch({
    ...
    return (
        <SwitchPrimitive.Root
            data-slot="switch"
            className={cn(
                'peer data-[state=checked]:bg-accent dark:data-[state=checked]:bg-accent-foreground data-[state=unchecked]:bg-input',
                'focus-visible:border-ring focus-visible:ring-ring/50 dark:data-[state=unchecked]:bg-input/80',
                'inline-flex h-[1.15rem] w-8 shrink-0 items-center rounded-full border border-transparent dark:data-[state=unchecked]:border-border shadow-xs',
