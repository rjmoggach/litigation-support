...
import {
    deleteConnectionApiV1EmailConnectionsConnectionsConnectionIdDelete,
    initiateOauthFlowApiV1EmailConnectionsOauthInitiatePost,
    listConnectionsApiV1EmailConnectionsConnectionsGet,
    refreshConnectionTokensApiV1EmailConnectionsConnectionsConnectionIdRefreshPost,
    testConnectionApiV1EmailConnectionsConnectionsConnectionIdTestPost,
...
export function EmailConnectionsManager() {
    ...
    const loadConnections = async () => {
        try {
            ...
            const response =
                await listConnectionsApiV1EmailConnectionsConnectionsGet({
                    client,
                })
    ...
    const handleDeleteConnection = async (connection: EmailConnection) => {
        try {
            ...
            await deleteConnectionApiV1EmailConnectionsConnectionsConnectionIdDelete(
                {
    ...
    const handleRefreshConnection = async (connection: EmailConnection) => {
        try {
            ...
            const response =
                await refreshConnectionTokensApiV1EmailConnectionsConnectionsConnectionIdRefreshPost(
                    {
                        path: { connection_id: connection.id },
                        client,
                    },
    ...
    const handleTestConnection = async (connection: EmailConnection) => {
        try {
            ...
            const response =
                await testConnectionApiV1EmailConnectionsConnectionsConnectionIdTestPost(
                    {
                        path: { connection_id: connection.id },
                        client,
                    },
