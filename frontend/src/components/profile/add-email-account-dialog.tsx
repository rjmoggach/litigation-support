...
export function AddEmailAccountDialog({
    ...
    const handleConnect = async () => {
        try {
            ...
            handleEmailConnectionError(error, 'Connecting email account')
        }
    }
    ...
    const permissions = [
        {
            ...
            description:
                'Access to read your email messages for evidence collection',
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Connect an additional Gmail or Google Workspace account
                    ...
                    <div className="flex items-start gap-3 p-3 bg-amber-50 border border-amber-200 rounded-md">
                        ...
                        <div className="text-sm">
                            ...
                            <div className="text-amber-700 space-y-1">
                                ...
                                <p>
                                    • We only access emails you explicitly grant
                                    permission for
                                </p>
                                <p>
