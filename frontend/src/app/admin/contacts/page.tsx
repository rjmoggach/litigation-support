...
import { CompanyList } from '@/components/admin/contacts/company-list'
import {
    DetailForm,
    SelectedItem,
    SelectedType,
} from '@/components/admin/contacts/detail-form'
import { PeopleList } from '@/components/admin/contacts/people-list'
